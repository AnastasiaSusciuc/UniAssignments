...
class FixedCapBiMap {
    ...
    // removes a key k with all the values that belong to it. Returns a ValuePair
    // containing the removed values in the way: following
    // If k had 2 associated values, these are in valuePair.
    // If k had 1 associated value, that value is the first component of the ValuePair,
    // the second component is NULL_TVALUE
    // If k had no associated value, both components of the returned ValuePair are NULL_TVALUE.
