...
//                if (relation(e, e))
//                {
                    int minimum = get_max(bst.left[current]);
                    remove(bst.info[minimum]);
                    bst.info[current] = bst.info[minimum];
//                }
//                else
//                {
//                    int minimum = getMin(bst.right[current]);
//                    remove(bst.info[minimum]);
//                    bst.info[current] = bst.info[minimum];
//                }
            }
...
int SortedBag::getMin(int node) const{
    int current = node;
...
int SortedBag::getMinimum(int node) const {
    int current = node;
    while (bst.left[current] != NULL_POS)
        current = bst.left[current];
    return current;
