...
void AdminService::add_tutorial_admin_service(const std::string &title,
    ...
    repository.admin_add_tutorial_in_repository(tutorial);
}

void AdminService::remove_tutorial_admin_service(const std::string &link) {
    repository.admin_remove_tutorial_in_repository(link);
}
...
void AdminService::update_tutorial_admin_service(const std::string &tutorial_to_update_link,
    ...
    repository.admin_update_tutorial_in_repository(tutorial_to_update_link,
                                                          new_tutorial_title,
...
void AdminService::increase_likes_tutorial_service(const std::string &link) {
    repository.admin_increase_likes_in_repository(link);
}

void AdminService::print_repo_address() {
    std::cout << &repository << '\n';
}
