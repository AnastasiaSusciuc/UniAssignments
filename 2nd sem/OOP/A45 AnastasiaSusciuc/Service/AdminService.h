...
#include "../Repository/TutorialsRepository.h"
...
public:
    ...
    ~AdminService();
    int add_tutorial_admin_service(const std::string &title,
     ...
     * */
    int remove_tutorial_admin_service(const std::string &link);
    /*
     * description:  creates a tutorial and adds it into the repository
     *
     * param1:       link - string - the link of the tutorial to be removed
     *
     * returns:      0 - there is a tutorial with this link in the repository, therefore the tutorial was removed successfully
     *               1 - there is a no tutorial with this link in the repository, therefore there is no such tutorial to be removed
     * */
     ...
     * */
    int update_tutorial_admin_service(const std::string &tutorial_to_update_link,
     ...
     *
     * returns:      0 - the link was not added before, therefore the tutorial was updated successfully
     *               1 - the link was added before, therefore the tutorial was not updated
     * */
     ...
     * */
    int size_repo() const;
    int increase_likes_tutorial_service(const std::string &link);
    /*
