...
void TestDG::test_Hamilton_TSP() {
    ...
    graph.add_edge(6, 1, 3);

    HamiltonHeuristic hamiltonHeuristic(graph);

    hamiltonHeuristic.approximate_tsp_nearest_neighbour();

//    std::cout << "Hamilton Cycle: ";
//    std::vector <int> hamilton_cycle = hamiltonHeuristic.get_hamilton_cycle();
//    for (auto i : hamilton_cycle)
//        std::cout << i << " ";
//    std::cout << "\n Cost: " << hamiltonHeuristic.get_hamilton_cycle_cost() << '\n';
//
//    graph.change_edge_cost(3, 4, 10);
//
//    hamiltonHeuristic.approximate_tsp_nearest_neighbour();
//
//    std::cout << "Hamilton Cycle: ";
//    hamilton_cycle = hamiltonHeuristic.get_hamilton_cycle();
//    for (auto i : hamilton_cycle)
//        std::cout << i << " ";
//    std::cout << "\n Cost: " << hamiltonHeuristic.get_hamilton_cycle_cost() << '\n';
...
void TestDG::test_minimum_cycle() {
    DirectedGraph graph;
    for (int i = 1; i <= 5; i++)
        graph.add_node(i);
...
//    graph.add_edge(6, 1, 3);
    ...
    MinimumCycle minimumCycle(graph);

    std::cout << minimumCycle.get_min_cycle() << '\n';
